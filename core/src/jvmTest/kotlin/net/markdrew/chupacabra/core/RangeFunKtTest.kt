...
internal class RangeFunKtTest {
    ...
    fun splitBefore() {
        ...
        assertFailsWith<IllegalArgumentException> { (1..5).splitBefore(1) }
        assertFailsWith<IllegalArgumentException> { (1..5).splitBefore(6) }
        assertFailsWith<IllegalArgumentException> { (1..5).splitBefore(0) }
    }
}