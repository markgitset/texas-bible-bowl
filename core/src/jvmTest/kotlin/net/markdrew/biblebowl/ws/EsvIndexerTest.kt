...
class EsvIndexerTest {
    ...
    @Test
    fun indexBookParsesTextVerseRangesAndFootnotes() {
        ...
        with(indexer.indexBook(sequenceOf(testPassage))) {
            ...
            assertEquals(actual = verses, expected = DisjointRangeMap(
                0..55 to 1001001,
                57..200 to 1001002,
                202..257 to 1001003,
                259..341 to 1001004,
                ...
                813..941 to 1001009,
                943..1090 to 1001010,
                1092..1115 to 1001011,
                1117..1370 to 1001026,
                1374..1490 to 1001027,
                1496..1729 to 1001028
            ).mapValues { (_, verseNum) -> verseNum.toVerseRef() })

            assertEquals<Map<Int, String>>(actual = footnotes, expected = mapOf(
                ...
                1091 to "test note 2",
                1097 to "test note 3",
                1148 to "The Hebrew word for *man* (*adam*) is the generic term for mankind and becomes the proper name *Adam*"
            ))
        }
    }
}
